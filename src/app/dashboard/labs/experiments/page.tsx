...
interface Test { id: string; folder_id: string; name: string; total_photos: number; successful_count: number; failed_count: number; accuracy_rate: number | null; avg_confidence: number | null; avg_processing_time_ms: number | null; total_cost_usd: number | null; status: string; experiment_folders?: { id: string; name: string }; experiment_test_results?: TestResult[] }
