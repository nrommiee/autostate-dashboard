...
import { ClipboardListIcon, CalendarIcon, TrendingUpIcon, EllipsisVerticalIcon } from 'lucide-react'
...
const TotalMissionsCard = ({ className, chartData, stats }: Props) => {
  const ReportData = [
    {
      ...
      <div className='space-y-4 py-6 max-lg:border-b lg:col-span-2 lg:border-r'>
        <CardHeader className='flex justify-between'>
          <div className='flex flex-col gap-1'>
            ...
            <span className='text-muted-foreground text-sm'>Rapport hebdomadaire</span>
          </div>
          <DropdownMenu>
        ...
        <CardContent className='pb-0'>
          <ChartContainer config={chartConfig} className='max-h-80 min-h-48 w-full max-[400px]:max-w-73'>
            ...
            >
              ...
              />
              <Area dataKey='missions' type='linear' fill='url(#fillMissions)' stroke='var(--chart-2)' stackId='a' />
            </AreaChart>
          </ChartContainer>
        </CardContent>
      </div>
...
export default TotalMissionsCard
